...
**Blue Lock** :
- [x] Blue Lock — 6 produits traités (2026-06-22) : Mug, Tableau, Porte Clé, Chiffonnette, Tapis de Souris, Magnet. Cluster franchise football/anime (perso = franchise, pas de perso unique sur les illustrations). Semrush fr : blue lock 49500/mois — Kaiser (9900), Nagi (4400), Shidou/Shindou (2900), Rin (2400), Bachira/Isagi (1900 chacun). Seul combo produit >50 : poster blue lock (170) → Tableau méta titre = "Poster Blue Lock". Tasse blue lock (40) > mug blue lock (20) → "Tasse" ouvre méta titre Mug. Cluster topique pur pour tous les autres produits. Aucune cannibalisation collection. Lore utilisé : Isagi/vision métavisionnaire (Mug), Ego/axiome égoïsme (Tableau), Nagi/génie naturel/Reo Mikage (Porte Clé), Bachira/monstre intérieur (Chiffonnette), Rin Itoshi/frère Sae (Tapis), Shidou/électron libre/tirs en volée (Magnet). P3 tournants : 4-8-6-2-1-9. 0 handle renommé (poster-blue-lock déjà optimal). Suffixes méta : Cadeau Manga / Affiche Anime / Goodies Manga / Cadeau Anime / Déco Manga / Cadeau Goodies. 8 alt texts mis à jour (5 variantes Tableau + Mug×2 + Porte Clé). PREMIÈRE franchise Blue Lock. Fichier final → blue_lock_seo_new.json.
