...
2. **Trace auditable** des volumes retenus par perso (avec date).
...
À intégrer NATURELLEMENT dans P1 / méta description quand "[produit] [perso]" est quasi nul (Étape 3.4). Ne jamais forcer.

| Keyword | Volume | Usage |
|---|---|---|
| figurine manga | 5400 | hors produit (pas vendu) mais signale l'intention d'achat manga |
| poster manga | 1000 | Tableau : P1 / texte |
| tableau manga | 880 | Tableau : P1 / texte |
| t shirt manga | 720 | T-Shirt : P1 / texte |
| poster anime | 590 | Tableau : P1 / texte |
| cadeau manga | 590 | angle cadeau, tous produits |
| mug manga | 260 | Mug : P1 / méta |
| goodies manga | 210 | angle collection, tous produits |
| tote bag manga | 20 | Tote Bag |
...
| Keyword | Volume | Usage |
|---|---|---|
| figurine bleach | 1000 | hors produit, signale intention d'achat Bleach |
| poster bleach | 170 | Tableau Bleach : texte (le méta titre reste "[produit] [perso]") |
| t shirt bleach | 170 | T-Shirt Bleach : texte |
| cadeau bleach | 20 | angle cadeau |
| goodies bleach | 20 | angle collection |
| mug bleach | 20 | Mug |
| tableau bleach | 20 | Tableau |
| affiche bleach | 20 | Tableau |

→ Note ownership : "[produit] bleach" appartient aux COLLECTIONS pour le méta titre, mais peut apparaître dans le TEXTE des fiches (CLAUDE.md règle de propriété).
...
- Combos produit :
  | Produit | Mesures | Retenu (méta titre) |
  |---|---|---|
  | Mug | mug 0 / tasse 0 | mug ulquiorra (topique) |
  | Tableau | tableau 0 / **poster 20** / affiche 0 / toile 0 / cadre 0 | **poster ulquiorra** (20) → méta titre inversé sur "Poster" |
  | Porte Clé | porte clé 0 / porte-clé 0 | porte clé ulquiorra (topique) |
  | Chiffonnette | chiffonnette 0 | topique |
  | Tapis | tapis de souris 0 / tapis 0 | topique |
  | Tote Bag | tote bag 0 / sac 0 | topique |
  | Magnet | magnet 0 / aimant 0 | topique |
